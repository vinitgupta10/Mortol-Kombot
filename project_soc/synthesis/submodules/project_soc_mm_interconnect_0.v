...
module project_soc_mm_interconnect_0 (
		...
		input  wire        player2_controller_0_RESET_reset_bridge_in_reset_reset, // player2_controller_0_RESET_reset_bridge_in_reset.reset
		...
		output wire [11:0] player2_controller_0_avl_mm_slave_address,              //                player2_controller_0_avl_mm_slave.address
		output wire        player2_controller_0_avl_mm_slave_write,                //                                                 .write
		output wire        player2_controller_0_avl_mm_slave_read,                 //                                                 .read
		input  wire [31:0] player2_controller_0_avl_mm_slave_readdata,             //                                                 .readdata
		output wire [31:0] player2_controller_0_avl_mm_slave_writedata,            //                                                 .writedata
		output wire [3:0]  player2_controller_0_avl_mm_slave_byteenable,           //                                                 .byteenable
		output wire        player2_controller_0_avl_mm_slave_chipselect,           //                                                 .chipselect
	...
	wire   [31:0] player2_controller_0_avl_mm_slave_agent_m0_readdata;                                // player2_controller_0_avl_mm_slave_translator:uav_readdata -> player2_controller_0_avl_mm_slave_agent:m0_readdata
	wire          player2_controller_0_avl_mm_slave_agent_m0_waitrequest;                             // player2_controller_0_avl_mm_slave_translator:uav_waitrequest -> player2_controller_0_avl_mm_slave_agent:m0_waitrequest
	wire          player2_controller_0_avl_mm_slave_agent_m0_debugaccess;                             // player2_controller_0_avl_mm_slave_agent:m0_debugaccess -> player2_controller_0_avl_mm_slave_translator:uav_debugaccess
	wire   [27:0] player2_controller_0_avl_mm_slave_agent_m0_address;                                 // player2_controller_0_avl_mm_slave_agent:m0_address -> player2_controller_0_avl_mm_slave_translator:uav_address
	wire    [3:0] player2_controller_0_avl_mm_slave_agent_m0_byteenable;                              // player2_controller_0_avl_mm_slave_agent:m0_byteenable -> player2_controller_0_avl_mm_slave_translator:uav_byteenable
	wire          player2_controller_0_avl_mm_slave_agent_m0_read;                                    // player2_controller_0_avl_mm_slave_agent:m0_read -> player2_controller_0_avl_mm_slave_translator:uav_read
	wire          player2_controller_0_avl_mm_slave_agent_m0_readdatavalid;                           // player2_controller_0_avl_mm_slave_translator:uav_readdatavalid -> player2_controller_0_avl_mm_slave_agent:m0_readdatavalid
	wire          player2_controller_0_avl_mm_slave_agent_m0_lock;                                    // player2_controller_0_avl_mm_slave_agent:m0_lock -> player2_controller_0_avl_mm_slave_translator:uav_lock
	wire   [31:0] player2_controller_0_avl_mm_slave_agent_m0_writedata;                               // player2_controller_0_avl_mm_slave_agent:m0_writedata -> player2_controller_0_avl_mm_slave_translator:uav_writedata
	wire          player2_controller_0_avl_mm_slave_agent_m0_write;                                   // player2_controller_0_avl_mm_slave_agent:m0_write -> player2_controller_0_avl_mm_slave_translator:uav_write
	wire    [2:0] player2_controller_0_avl_mm_slave_agent_m0_burstcount;                              // player2_controller_0_avl_mm_slave_agent:m0_burstcount -> player2_controller_0_avl_mm_slave_translator:uav_burstcount
	wire          player2_controller_0_avl_mm_slave_agent_rf_source_valid;                            // player2_controller_0_avl_mm_slave_agent:rf_source_valid -> player2_controller_0_avl_mm_slave_agent_rsp_fifo:in_valid
	wire  [108:0] player2_controller_0_avl_mm_slave_agent_rf_source_data;                             // player2_controller_0_avl_mm_slave_agent:rf_source_data -> player2_controller_0_avl_mm_slave_agent_rsp_fifo:in_data
	wire          player2_controller_0_avl_mm_slave_agent_rf_source_ready;                            // player2_controller_0_avl_mm_slave_agent_rsp_fifo:in_ready -> player2_controller_0_avl_mm_slave_agent:rf_source_ready
	wire          player2_controller_0_avl_mm_slave_agent_rf_source_startofpacket;                    // player2_controller_0_avl_mm_slave_agent:rf_source_startofpacket -> player2_controller_0_avl_mm_slave_agent_rsp_fifo:in_startofpacket
	wire          player2_controller_0_avl_mm_slave_agent_rf_source_endofpacket;                      // player2_controller_0_avl_mm_slave_agent:rf_source_endofpacket -> player2_controller_0_avl_mm_slave_agent_rsp_fifo:in_endofpacket
	wire          player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid;                         // player2_controller_0_avl_mm_slave_agent_rsp_fifo:out_valid -> player2_controller_0_avl_mm_slave_agent:rf_sink_valid
	wire  [108:0] player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_data;                          // player2_controller_0_avl_mm_slave_agent_rsp_fifo:out_data -> player2_controller_0_avl_mm_slave_agent:rf_sink_data
	wire          player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready;                         // player2_controller_0_avl_mm_slave_agent:rf_sink_ready -> player2_controller_0_avl_mm_slave_agent_rsp_fifo:out_ready
	wire          player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket;                 // player2_controller_0_avl_mm_slave_agent_rsp_fifo:out_startofpacket -> player2_controller_0_avl_mm_slave_agent:rf_sink_startofpacket
	wire          player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket;                   // player2_controller_0_avl_mm_slave_agent_rsp_fifo:out_endofpacket -> player2_controller_0_avl_mm_slave_agent:rf_sink_endofpacket
	wire          player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid;                       // player2_controller_0_avl_mm_slave_agent:rdata_fifo_src_valid -> player2_controller_0_avl_mm_slave_agent_rdata_fifo:in_valid
	wire   [33:0] player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_data;                        // player2_controller_0_avl_mm_slave_agent:rdata_fifo_src_data -> player2_controller_0_avl_mm_slave_agent_rdata_fifo:in_data
	wire          player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready;                       // player2_controller_0_avl_mm_slave_agent_rdata_fifo:in_ready -> player2_controller_0_avl_mm_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> player2_controller_0_avl_mm_slave_agent:cp_valid
	wire  [107:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> player2_controller_0_avl_mm_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // player2_controller_0_avl_mm_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [18:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> player2_controller_0_avl_mm_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> player2_controller_0_avl_mm_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> player2_controller_0_avl_mm_slave_agent:cp_endofpacket
	...
	wire   [18:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> keycode1_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> keycode2_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_017_src_channel;                                                            // cmd_mux_017:src_channel -> keycode3_s1_agent:cp_channel
	...
	wire          player2_controller_0_avl_mm_slave_agent_rp_valid;                                   // player2_controller_0_avl_mm_slave_agent:rp_valid -> router_003:sink_valid
	wire  [107:0] player2_controller_0_avl_mm_slave_agent_rp_data;                                    // player2_controller_0_avl_mm_slave_agent:rp_data -> router_003:sink_data
	wire          player2_controller_0_avl_mm_slave_agent_rp_ready;                                   // router_003:sink_ready -> player2_controller_0_avl_mm_slave_agent:rp_ready
	wire          player2_controller_0_avl_mm_slave_agent_rp_startofpacket;                           // player2_controller_0_avl_mm_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          player2_controller_0_avl_mm_slave_agent_rp_endofpacket;                             // player2_controller_0_avl_mm_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire   [18:0] cmd_demux_src6_channel;                                                             // cmd_demux:src6_channel -> crosser_001:in_channel
	...
	wire   [18:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_006:sink0_channel
	...
	wire   [18:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_002:in_channel
	...
	wire   [18:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_006:sink1_channel
	...
	wire   [18:0] rsp_demux_001_src0_channel;                                                         // rsp_demux_001:src0_channel -> crosser_003:in_channel
	...
	wire   [18:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux:sink1_channel
	...
	wire   [18:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_004:in_channel
	...
	wire   [18:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink6_channel
	...
	wire   [18:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_005:in_channel
	...
	wire   [18:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink5_channel
	...
	wire          player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_valid;                       // player2_controller_0_avl_mm_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_data;                        // player2_controller_0_avl_mm_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_001:in_0_ready -> player2_controller_0_avl_mm_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> player2_controller_0_avl_mm_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> player2_controller_0_avl_mm_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // player2_controller_0_avl_mm_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> player2_controller_0_avl_mm_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) player2_controller_0_avl_mm_slave_translator (
		.clk                    (sdram_pll_c0_clk),                                         //                      clk.clk
		.reset                  (player2_controller_0_RESET_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (player2_controller_0_avl_mm_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (player2_controller_0_avl_mm_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (player2_controller_0_avl_mm_slave_agent_m0_read),          //                         .read
		.uav_write              (player2_controller_0_avl_mm_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (player2_controller_0_avl_mm_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (player2_controller_0_avl_mm_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (player2_controller_0_avl_mm_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (player2_controller_0_avl_mm_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (player2_controller_0_avl_mm_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (player2_controller_0_avl_mm_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (player2_controller_0_avl_mm_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (player2_controller_0_avl_mm_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (player2_controller_0_avl_mm_slave_write),                  //                         .write
		.av_read                (player2_controller_0_avl_mm_slave_read),                   //                         .read
		.av_readdata            (player2_controller_0_avl_mm_slave_readdata),               //                         .readdata
		.av_writedata           (player2_controller_0_avl_mm_slave_writedata),              //                         .writedata
		.av_byteenable          (player2_controller_0_avl_mm_slave_byteenable),             //                         .byteenable
		.av_chipselect          (player2_controller_0_avl_mm_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                         //              (terminated)
		.av_beginbursttransfer  (),                                                         //              (terminated)
		.av_burstcount          (),                                                         //              (terminated)
		.av_readdatavalid       (1'b0),                                                     //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) player2_controller_0_avl_mm_slave_agent (
		.clk                     (sdram_pll_c0_clk),                                                   //             clk.clk
		.reset                   (player2_controller_0_RESET_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (player2_controller_0_avl_mm_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (player2_controller_0_avl_mm_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (player2_controller_0_avl_mm_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (player2_controller_0_avl_mm_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (player2_controller_0_avl_mm_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (player2_controller_0_avl_mm_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (player2_controller_0_avl_mm_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (player2_controller_0_avl_mm_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (player2_controller_0_avl_mm_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (player2_controller_0_avl_mm_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (player2_controller_0_avl_mm_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (player2_controller_0_avl_mm_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (player2_controller_0_avl_mm_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (player2_controller_0_avl_mm_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (player2_controller_0_avl_mm_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (player2_controller_0_avl_mm_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (player2_controller_0_avl_mm_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (player2_controller_0_avl_mm_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (player2_controller_0_avl_mm_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (player2_controller_0_avl_mm_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (player2_controller_0_avl_mm_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                                  //                .error
		.rdata_fifo_src_ready    (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) player2_controller_0_avl_mm_slave_agent_rsp_fifo (
		.clk               (sdram_pll_c0_clk),                                                   //       clk.clk
		.reset             (player2_controller_0_RESET_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (player2_controller_0_avl_mm_slave_agent_rf_source_data),             //        in.data
		.in_valid          (player2_controller_0_avl_mm_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (player2_controller_0_avl_mm_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (player2_controller_0_avl_mm_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (player2_controller_0_avl_mm_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (player2_controller_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                              // (terminated)
		.csr_read          (1'b0),                                                               // (terminated)
		.csr_write         (1'b0),                                                               // (terminated)
		.csr_readdata      (),                                                                   // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) player2_controller_0_avl_mm_slave_agent_rdata_fifo (
		.clk               (sdram_pll_c0_clk),                                             //       clk.clk
		.reset             (player2_controller_0_RESET_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (player2_controller_0_avl_mm_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	project_soc_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (player2_controller_0_avl_mm_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (player2_controller_0_avl_mm_slave_agent_rp_valid),         //          .valid
		.sink_data          (player2_controller_0_avl_mm_slave_agent_rp_data),          //          .data
		.sink_startofpacket (player2_controller_0_avl_mm_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (player2_controller_0_avl_mm_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (sdram_pll_c0_clk),                                         //       clk.clk
		.reset              (player2_controller_0_RESET_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	project_soc_mm_interconnect_0_router_002 router_006 (
	...
	project_soc_mm_interconnect_0_router_002 router_007 (
	...
	project_soc_mm_interconnect_0_router_008 router_008 (
	...
	project_soc_mm_interconnect_0_router_002 router_020 (
	...
	project_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_cmd_mux cmd_mux_018 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_soc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	project_soc_mm_interconnect_0_rsp_demux rsp_demux_018 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (player2_controller_0_RESET_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (player2_controller_0_RESET_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	project_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (player2_controller_0_RESET_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (player2_controller_0_avl_mm_slave_agent_rdata_fifo_out_ready), //         .ready
	...
	project_soc_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
