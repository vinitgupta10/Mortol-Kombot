...
module lab61soc_mm_interconnect_0 (
		...
		input  wire        accumulate_reset_reset_bridge_in_reset_reset,   //   accumulate_reset_reset_bridge_in_reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (accumulate_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (accumulate_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (accumulate_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
